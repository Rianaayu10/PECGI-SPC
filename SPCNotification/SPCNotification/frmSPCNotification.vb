        ...
        Else
            ...
            ElseIf Type = "Content" Then
                With gridNGResult
                    ...
                    For i = 0 To dtNG.Rows.Count - 1
                        .AddItem("")
                        Dim DigitDecimal As Integer = dtNG.Rows(i)("DecimalDigit")
                        ...
                        .Item(i + 1, NGResult.pShift) = dtNG.Rows(i)("ShiftCode").ToString()
                        .Item(i + 1, NGResult.pSeq) = dtNG.Rows(i)("SequenceNo").ToString()
                        .Item(i + 1, NGResult.pUSL) = Format(dtNG.Rows(i)("USL"), f).ToString()
                        .Item(i + 1, NGResult.pLSL) = Format(dtNG.Rows(i)("LSL"), f).ToString()
                        .Item(i + 1, NGResult.pUCL) = Format(dtNG.Rows(i)("UCL"), f).ToString()
                        .Item(i + 1, NGResult.pLCL) = Format(dtNG.Rows(i)("LCL"), f).ToString()
                        .Item(i + 1, NGResult.pMin) = Format(dtNG.Rows(i)("MinValue"), f).ToString()
                        .Item(i + 1, NGResult.pMax) = Format(dtNG.Rows(i)("MaxValue"), f).ToString()
                        .Item(i + 1, NGResult.pAve) = Format(dtNG.Rows(i)("Average"), f).ToString()
                        .Item(i + 1, NGResult.pOperator) = dtNG.Rows(i)("Operator").ToString()
                        .Item(i + 1, NGResult.pMK) = dtNG.Rows(i)("MK").ToString()
                        .Item(i + 1, NGResult.pQC) = dtNG.Rows(i)("QC").ToString()
            ...
            ElseIf Type = "Content" Then
                With gridDelayVerification
                    ...
                    For i = 0 To dtDelayVerification.Rows.Count - 1
                        ...
                        .Item(i + 1, DelayVerification.pShift) = dtDelayVerification.Rows(i)("ShiftCode").ToString()
                        .Item(i + 1, DelayVerification.pSeq) = dtDelayVerification.Rows(i)("SequenceNo").ToString()
                        .Item(i + 1, DelayVerification.pUSL) = Format(dtDelayVerification.Rows(i)("USL"), f).ToString()
                        .Item(i + 1, DelayVerification.pLSL) = Format(dtDelayVerification.Rows(i)("LSL"), f).ToString()
                        .Item(i + 1, DelayVerification.pUCL) = Format(dtDelayVerification.Rows(i)("UCL"), f).ToString()
                        .Item(i + 1, DelayVerification.pLCL) = Format(dtDelayVerification.Rows(i)("LCL"), f).ToString()
                        .Item(i + 1, DelayVerification.pMin) = Format(dtDelayVerification.Rows(i)("MinValue"), f).ToString()
                        .Item(i + 1, DelayVerification.pMax) = Format(dtDelayVerification.Rows(i)("MaxValue"), f).ToString()
                        .Item(i + 1, DelayVerification.pAve) = Format(dtDelayVerification.Rows(i)("Average"), f).ToString()
                        .Item(i + 1, DelayVerification.pOperator) = dtDelayVerification.Rows(i)("Operator").ToString()
                        .Item(i + 1, DelayVerification.pMK) = dtDelayVerification.Rows(i)("MK").ToString()
                        .Item(i + 1, DelayVerification.pQC) = dtDelayVerification.Rows(i)("QC").ToString()
                        .Item(i + 1, DelayVerification.pVerifTime) = dtDelayVerification.Rows(i)("VerifTime").ToString()

...
namespace SPCMeasurement
{
    ...
    class clsLineGroupDB
    {
        ...
        public static void FillCombo(C1.Win.C1List.C1Combo cbo, string UserID, string FactoryCode, string ProcessGroup)
        {
            ...
            using (SqlConnection cn = new SqlConnection(constr))
            {
                ...
                cbo.ValueMember = "LineGroup";
                cbo.DisplayMember = "LineGroupName";

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AlertDelayInput.aspx.vb" Inherits="PECGI_SPC.AlertDashboardInput" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div id="divhead" style="padding: 0px 5px 5px 5px">
        ...
        <div style="padding: 10px 5px 5px 5px">
            ...
            <div class="bg-color-grayDark" style="width: 100%">
                <center>

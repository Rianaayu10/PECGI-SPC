    ...
    <div id="divhead" style="padding: 5px 5px 5px 5px; border-bottom-color: #a9a9a9; border-bottom-style: inset; border-bottom-width: 1px">
        ...
        <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" ClientInstanceName="Grid"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Last User" FieldName="UpdateUser" VisibleIndex="9"
                ...
                <dx:GridViewDataTextColumn Caption="Last Update" FieldName="UpdateDate" VisibleIndex="10"
